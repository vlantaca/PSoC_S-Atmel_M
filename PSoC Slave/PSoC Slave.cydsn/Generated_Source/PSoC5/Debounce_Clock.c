...
{
    if (Debounce_Clock_CLKEN & Debounce_Clock_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void Debounce_Clock_SetModeRegister(uint8 clkMode) 
{
    Debounce_Clock_MOD_SRC |= clkMode & Debounce_Clock_MODE_MASK;
}
...
*
*******************************************************************************/
void Debounce_Clock_ClearModeRegister(uint8 clkMode) 
{
    Debounce_Clock_MOD_SRC &= ~clkMode | ~Debounce_Clock_MODE_MASK;
}
...
{
    return Debounce_Clock_MOD_SRC & Debounce_Clock_MODE_MASK;
}
...
void Debounce_Clock_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Debounce_Clock_MOD_SRC =
            (Debounce_Clock_MOD_SRC & ~Debounce_Clock_SRC_SEL_MSK) | clkSource;
    }
