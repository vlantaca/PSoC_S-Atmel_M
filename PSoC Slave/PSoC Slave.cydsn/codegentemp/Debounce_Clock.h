...
void Debounce_Clock_SetDividerRegister(uint16 clkDivider, uint8 reset) ;
...
#define Debounce_Clock_SetDivider(clkDivider)         Debounce_Clock_SetDividerRegister(clkDivider, 1)
#define Debounce_Clock_SetDividerValue(clkDivider)    Debounce_Clock_SetDividerRegister((clkDivider) - 1, 1)
...
#define Debounce_Clock_SetPhaseValue(clkPhase)        Debounce_Clock_SetPhaseRegister((clkPhase) + 1)
#endif
